...
<div class="page">
    ...
    <div class="card">
        ...
        <p>Manage patient records — admit, edit, discharge and delete.</p>
    </div>
    ...
    <div class="card">
        ...
        <?php if (empty($patients)): ?>
            <p style="color:#666;text-align:center;padding:24px 0;">
                No patients yet. <a href="add-patient.php">Admit the first one!</a>
            </p>
        <?php else: ?>
            ...
            <div class="patient-row">
                ...
                <div class="patient-actions">
                    <a href="edit-patient.php?id=<?= $p['id'] ?>"
                    ...
                    <a href="dashboard.php?delete=<?= $p['id'] ?>"
                       ...
                       onclick="return confirm('Delete record for <?= htmlspecialchars($p['name'], ENT_QUOTES) ?>?')">Delete</a>
                </div>
            </div>
            <?php endforeach; ?>
        <?php endif; ?>
